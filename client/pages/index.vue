...
<template>
  <div class="index">
    <div id="app" class="index back">
      <v-app app id="inspire">
        <v-app-bar height="100px" app color="semi-transparent">
          ...
          >
          <v-spacer></v-spacer>
          <v-btn class="white black--text ml-2" elevation="0" href="/">
            Home
          </v-btn>
        ...
        <v-content>
          <v-container grid-list-lg>
            <v-row>
              ...
              <v-col cols="12">
                <v-card class="mx-auto white" min-height="100" flat>
                  <v-card-text
                    class="text-h1 blue-grey--text text-lighten-1 font-weight-black pa-5 mt-10"
                  >
                    PWD PORTAL
                    <p
                      class="text-h2 success--text font-weight-light "
                    >
              ...
              <v-col cols="4">
                <v-card class="mx-auto white pa-4" min-height="100" flat>
            ...
            <v-card elevation="0" rounded-lg light>
              <v-row>              
    ...
    >
      <v-carousel-item
        v-for="(slide, i) in slides123"
        :key="i"
      >
      <v-row>
      <v-col cols="6" >
        <v-img min-height=250px :src="slide.src"></v-img>
      </v-col>
      <v-col cols="6">
          <div vertical layout>           
            <div class="text-h4 black--text">{{slide.title}}</div>
            <div class="text-h6 red--text "><p>{{slide.text}}</p></div>
            </div>
                ...
                <v-card class="mx-auto transparent" dark min-height="50" flat>
                  <p class="pa-5 green--text">News and Updates</p>
                  <ul v-for="(item,i) in news" :key="i" class="pa-5">
...
export default {
  ...
  data: () => ({
    news:[{src:"www.google.com",title:"Google announced "}],
      ...
      {
        src: "http://www.kinfratech.com/wp-content/uploads/2016/07/roadworks2.jpg",
      ...
      {
        src: "https://3.imimg.com/data3/IQ/WI/MY-924799/building-works-500x500.jpg",
        text: "Tender for term contract ( building ) 2021-22 term contract ( building ) 2021-22",
        title: "Building Construction",
      },
      {
        src: "https://images.newindianexpress.com/uploads/user/imagelibrary/2017/11/5/w600X300/Govtlkji.jpg",
        text: "Tender for term contract (school building) 2021-22 term contract ( school building ) 2021-22",
        title: "Building Construction",
      },
      {
        src: "https://gumlet.assettype.com/freepressjournal%2F2020-01%2Fddfa26c6-1388-4470-b16d-a71b26db227f%2Fcats.jpg?w=1200",
      ...
      {
        src: "http://grossreservoir.org/wp-content/uploads/2018/08/101817-Raising-the-Dam-36-x-24-009-1.jpg",
      ...
      {
        src: "https://static.theprint.in/wp-content/uploads/2020/03/Railway-construction-696x392.jpg",
      ...
      {
        src: "https://assets-news.housing.com/news/wp-content/uploads/2018/09/24202353/Construction-of-elevated-flyover-on-Gurugram-Alwar-Road-to-begin-from-September-21-2018-FB-1200x628-compressed.jpg",
